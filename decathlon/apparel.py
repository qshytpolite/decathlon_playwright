...
# scraping product urls by category.
...
# Extraction or MRP of the products.
...
# Extraction of the Number of Reviews of the product
...
async def get_Product_description(page):
    try:
        ...
        Product_description = [
            bp.strip() for bp in Product_description if bp.strip() and "A photo" not in bp]
